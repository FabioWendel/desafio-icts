...
class Produtos extends Component {
  ...
  render() {
    const { dataSeach, data, deleteModal,editModal, showModalAdd, showModalCart, itemSelect, isEmpty } = this.state;
    return (
      <div className="wrapper-pd">
        <div className="top-pd">
          ...
          <Button 
            ...
            labelPosition='left'
            icon
            onClick={() => {this.setState({ showModalCart: true})}}
          >
            <Icon name='cart' />
            Carrinho
          </Button>
        ...
        <ModalCart
          show={showModalCart}
          callback={(value) => {
            this.setState({ showModalCart: value });
          }}
        />
        <ModalAdd
          show={showModalAdd}
